...
export function ImageSlider() {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      tag: 'STUDENT INITIATIVES',
      title: 'AiMSA Student Chapter',
      subtitle: 'Fostering Innovation in AI & ML',
      description: 'Active student chapters organizing technical events, workshops, and hackathons.',
      caption: 'AIMSA & GFG STUDENT CHAPTER COORDINATORS',
    },
    {
      image: '/images/nvidia.jpg',
      tag: 'STATE-OF-THE-ART LABS',
      title: 'NVIDIA AI/DL Embedded Lab',
      subtitle: 'Advanced Computing Infrastructure',
      description: 'Well-equipped laboratories providing hands-on experience with modern AI technologies.',
      caption: 'NVIDIA® AI/DL EMBEDDED LAB',
    },
  ]
